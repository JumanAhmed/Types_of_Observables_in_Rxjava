...
public class CompletableObserverActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // either success or failure. This observable can be used when you want to perform some
        // task and not expect any value. A use case would be updating some data on the server
        // by making PUT request.
